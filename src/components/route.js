...
var platform;
export const calculateRouteFromAtoB = platForm => {
...
var map = new window.H.Map(mapContainer, defaultLayers.normal.map, {
...
var ui = new window.H.ui.UI.createDefault(map, defaultLayers);
